          ...
          <v-col cols="12" sm="7">
            ...
            <div class="list-group list-group-sm mb-7">
              ...
              <div
                ...
                v-show="paymentMethod === 'payByCard'"
              >
                <v-row>
                  <v-col cols="12">
                    <input
                      ...
                      <div class="input-group-append">
                        <span class="input-group-text tooltip">
                          ...
                          <span class="tooltip-text">
                            The CVV Number on your credit card or debit card is
                            a 3 digit number on VISA, MasterCard and Discover
          ...
          <v-col cols="12" sm="5" md="4" class="offset-md-1">
            ...
            <div class="bg-light pa-6 mb-9">
              ...
              <div class="subtotal-details font-size-lg font-weight-bold pb-0">
                <span>Total</span>
                <span>
                  {{ (cartSubtotal * 1.1 + shippingFee) | currencyFormatter }}
                </span>
              </div>
            </div>
